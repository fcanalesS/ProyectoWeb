    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    {!! Form::model($depto, ['route' => ['admin.campus.update_d', $depto->id], 'method' => 'PUT', 'role' => 'form']) !!}
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('facultad_id', (['0' => ''] + $f ), null, ['class' => 'form-control', 'required']) !!}
                            </div>
                            <div class="form-group">
                    ...
                    {!! Form::close() !!}
                    <br>
                    <a href="{{ url('admin/campus#d') }}" class="btn bg-aqua">Volver</a>
                </div><!-- /.box-body -->
