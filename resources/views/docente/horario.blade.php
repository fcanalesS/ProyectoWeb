    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('docente.index') }}"><i class="fa fa-user"></i><span>Volver</span></a></li>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <table id="horario" class="table table-bordered">
                                ...
                                @foreach($horario as $h)
                                    <tr>
                                        <td>{{ $h->fecha }}</td>
                                        <td>{{ $h->bloque }} - {{ $h->inicio }} - {{ $h->fin }}</td>
                                        <td>{{ $h->cod }} - {{ $h->ramo }}</td>
                                        <td>{{ $h->seccion }} - {{ $h->semestre }} - {{ $h->anio }}</td>
                                        <td>{{ $h->sala }}</td>
                                        <td>{{ $h->tipo }}</td>
                                        <td>{{ $h->campus }}</td>
                                    </tr>
            ...
            <div class="row">
                ...
                <section class="col-lg-6 connectedSortable">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            {!! Form::open(['route' => ['docente.resultado.salas'], 'method' => 'POST']) !!}
                            <div class="row">
                                <div class="col-md-4">
