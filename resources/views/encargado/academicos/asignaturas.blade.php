    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    {!! Form::model($asignaturas, ['route' => ['encargado.actualizar.asignatura'], 'method' => 'PUT', 'role' => 'form']) !!}
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            {!! Form::close() !!}
                            <a href="/encargado/academicos/{{$rut}}#asig" type="button" class="btn bg-aqua">Volver</a>
                        </div>
                        <div class="col-md-5">
                            @if(Session::has('asignatura_update'))
                                <div class="alert alert-info alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <h4><i class="icon fa fa-info"></i> Información!</h4>
                                    {{ Session::get('asignatura_update') }}
                                </div>
                            @endif
                        </div>
                    </div>
