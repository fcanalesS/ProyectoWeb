    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    {!! Form::model($carrera, ['route' => ['encargado.ingreso-datos.update_carrera', $carrera], 'method' => 'PUT', 'role' => 'form']) !!}
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <label for="">Codigo de carrera</label>
                                {!! Form::text('codigo', $carrera->codigo,['class' => 'form-control', 'maxlength' => '10']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('escuela_id', (['0' => 'Escuela'] + $escuela_lists ), null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <br/>
            ...
            <div class="box-footer">
                <div class="col-md-6 col-lg-6 col-md-offset-3 col-lg-offset-3">
                    <div class="callout callout-warning">
                        @if(Session::has('error_escuela'))
                            {{ Session::get('error_escuela') }}
                        @endif
                    </div>
                </div>
            </div>
