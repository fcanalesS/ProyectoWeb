    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    {!! Form::model($curso, ['route' => ['encargado.ingreso-datos.update_curso', $curso], 'method' => 'PUT', 'role' => 'form']) !!}
                    <div class="form-group">
                        <label for="">Asignaturas:</label>
                        {!! Form::select('asignatura_id', (['0' => 'Asignaturas'] + $asig_lists ), null, ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group">
                        <label for="">Docentes:</label>
                        {!! Form::select('asignatura_id', (['0' => 'Docentes'] + $doc_lists ), null, ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4 col-lg-4">
                                <label for="">Sección:</label>
                                {!! Form::text('seccion', $curso->seccion,['class' => 'form-control']) !!}
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <label for="">Semestre:</label>
                                {!! Form::number('semestre', $curso->semestre,['class' => 'form-control']) !!}
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <label for="">Año:</label>
                                {!! Form::number('anio', $curso->anio,['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    {!! Form::hidden('id', $id) !!}
