    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    {!! Form::model($estudiante, ['route' => ['encargado.ingreso-datos.update_estudiante', $estudiante], 'method' => 'PUT', 'role' => 'form']) !!}
                        <div class="row">
                            <div class="col-md-8 col-lg-8">
                                <label for="">Rut</label>
                                {!! Form::text('num', $datos['num'],['class' => 'form-control']) !!}
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    {!! Form::text('nombre1', $datos['nombres'][0],['class' => 'form-control', 'placeholder' => 'Primer Nombre']) !!}
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    {!! Form::text('nombre2', $datos['nombres'][1],['class' => 'form-control', 'placeholder' => 'Segundo Nombre']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    {!! Form::text('apellido1', $datos['apellidos'][0],['class' => 'form-control', 'placeholder' => 'Primer Apellido']) !!}
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    {!! Form::text('apellido2', $datos['apellidos'][1],['class' => 'form-control', 'placeholder' => 'Segundo Apellido']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ingrese E-mail</label>
                            {!! Form::email('email', $datos['email'],['class' => 'form-control', 'placeholder' => 'E-mail']) !!}
                        </div>
                        <div class="form-group">
