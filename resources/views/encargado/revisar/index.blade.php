                        ...
                        <div class="col-md-7 col-lg-7">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 form-group">
                                    {!! Form::text('nombre1', $datos['nombres'][0], ['class' => 'form-control', 'readonly']) !!}
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::text('nombre1', $datos['nombres'][1], ['class' => 'form-control', 'readonly']) !!}
                                </div>
                            </div>
                            <label for="">Apellidos</label>
                            <div class="row form-group">
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::text('nombre1', $datos['apellidos'][0], ['class' => 'form-control', 'readonly']) !!}
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::text('nombre1', $datos['apellidos'][1], ['class' => 'form-control', 'readonly']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Rut</label>
                                {!! Form::text('rut', $datos['rut'], ['class' => 'form-control', 'readonly']) !!}
                            </div>
                            <div class="form-group">
                                <label for="">E-mail</label>
                                {!! Form::text('email', $datos['email'], ['class' => 'form-control', 'readonly']) !!}
                            </div>
                        </div>
                        <div class="col-md-5 col-lg-5">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Asignaturas cursadas</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                        <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                                    </div>
